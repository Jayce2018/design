...
<div class="nav">
	<ul>
		...
		<li><a href="userlist.jsp">用户审核</a></li>
		<li><a href="xiajiaqn.jsp">问卷下架</a></li>
		<li><a href="#">商家一览</a></li>
		<li><a href="#">活动一览</a></li>
		<li><a href="#">数据查询
		<div class="xs">
			<div class="xiao"></div>
			<img src="../images/xialatu/3.jpg" />
		</div>
		</a></li>
		<li><a href="#">个人信息
		<div class="xs">
			<div class="xiao"></div>
			<img src="../images/xialatu/4.jpg" />
		</div>
		</a></li>
		<li><a href="#">平台地图</a></li>
		<li><a href="#">服务</a></li>
